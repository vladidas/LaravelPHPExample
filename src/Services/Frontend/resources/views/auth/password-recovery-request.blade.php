@extends('frontend::layouts.unauthorized', ['pageClass' => 'fp-page'])
    ...
    <div class="fp-box">
        ...
        <div class="card">
            <div class="body">
                ...
                @else
                    {!! Form::open(['route' => 'frontend.auth.accept-password-recovery-request', 'id' => 'forgot_password', 'method' => 'post']) !!}
                    ...
                    <div class="row m-t-20 m-b--5 align-center">
                        <a href="{{ route('frontend.auth.login') }}">{{ __('app.login') }}</a>
                    </div>
                    {!! Form::close() !!}
                @endif
            </div>
