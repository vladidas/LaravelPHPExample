...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        'dashboard.auth' => [
            \App\Services\Dashboard\Http\Middleware\Authenticate::class
        ],

        'dashboard.!auth' => [
            \App\Services\Dashboard\Http\Middleware\RedirectIfAuthenticated::class
        ],

        'frontend.auth' => [
            \App\Services\Frontend\Http\Middleware\Authenticate::class
        ],

        'frontend.!auth' => [
            \App\Services\Frontend\Http\Middleware\RedirectIfAuthenticated::class
        ],
    ...
    protected $routeMiddleware = [
        ...
        'gate' => \Framework\Http\Middleware\Gate::class,
